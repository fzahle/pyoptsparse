...
class IPOPT(Optimizer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        def_opts = {
            ...
            'warm_start_mult_init_max' : [float, 1e+06],
            ...
            'expect_infeasible_problem_ytol' : [float, 1e+08],
            ...
            'limited_memory_init_val_max' : [float, 1e+08],
